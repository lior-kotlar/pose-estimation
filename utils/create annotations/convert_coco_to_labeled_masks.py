...
Convert coco json labels to labeled train_masks and copy original train_images to place
them along with the train_masks.
...
Images: Download train_images.zip by following the link: http://livecell-dataset.s3.eu-central-1.amazonaws.com/LIVECell_dataset_2021/images.zip
...
def main(json_file, mask_output_folder, image_output_folder, original_image_dir):
    ...
    for img in images:
        # Create the train_masks
        create_mask(img, annotations, mask_output_folder)

        # Copy original train_images to the specified folder
...
if __name__ == '__main__':
    original_image_dir = r"C:\Users\amita\PycharmProjects\pythonProject\vision\train_nn_project\utils\wings_segmentation\create_annotations\input\train_images"  # Where your original train_images are stored
    json_file = r'C:\Users\amita\PycharmProjects\pythonProject\vision\train_nn_project\utils\wings_segmentation\create_annotations\input\annotations\labels_4000_wings_masks_2024-01-04-12-21-09.json'
    mask_output_folder = r'C:\Users\amita\PycharmProjects\pythonProject\vision\train_nn_project\utils\wings_segmentation\create_annotations\input\annotations\new_train_masks'  # Modify this as needed. Using val2 so my data is not overwritten
    image_output_folder = r'C:\Users\amita\PycharmProjects\pythonProject\vision\train_nn_project\utils\wings_segmentation\create_annotations\input\annotations\new_images_folder'  #
