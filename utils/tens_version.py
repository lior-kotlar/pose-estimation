...
with h5py.File("/cs/labs/tsevi/lior.kotlar/pose-estimation/from 2D to 3D/models 5.0/per wing/MODEL_18_POINTS_PER_WING_Jun 09 0.7-1.3 not reprojected/best_model.h5", "r") as f:
